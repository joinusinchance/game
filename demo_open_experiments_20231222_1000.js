...
//            on_workbench[1].sprite.visible = false;
            ...
            /*
            collected_items[from_item_id[0]].previousStatus = 'on bench';        
            collected_items[from_item_id[0]].currentStatus = 'move to shelf';
 
            collected_items[from_item_id[1]].previousStatus = 'on bench';        
            collected_items[from_item_id[1]].currentStatus = 'move to shelf';
            */
            ...
            //collected_items[from_item_id[1]].sprite.image = collected_items[from_item_id[1]].name;
            collected_items[from_item_id[1]].sprite.setTexture(collected_items[from_item_id[1]].name);

            collected_items[from_item_id[1]].sprite.x = spriteDrawPosition1[0];
            collected_items[from_item_id[1]].sprite.y = spriteDrawPosition1[1];

...
var items; // on object with all items details
var collected_items = []; // items which the user has collected
var item_here = []; // array of sprites

var a_game = new Phaser.Game(config);

function preload() {
    // special location images
